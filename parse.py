...
US_38 = list_upcoming_birthdays(individuals)
US_35 = list_recent_births(individuals)
US_17 = no_Marriage_To_Decendants(individuals, families)
US_18 = no_Sibling_Marriage(individuals, families)